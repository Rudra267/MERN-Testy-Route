    ...
    <div className={css.outerDiv}>
        <div className={css.innerDiv}>
            ...
            <div  className={css.sec}>
                <span className={css.delivery}> <div className={css.starDiv}>{stars} <img src={starImg} className={css.starIcon} alt='star' /></div> <span className={css.delTxt}>Before</span></span>
