...
import ImgSrc from '../../../assets/images/proandproplus.jpg';
   ...
   useEffect(() => {
    switch(hashId){
        case photosPage:
            ...
            break;
        case followersPage:
            setCurrComp(<UserFollowersCard hashId={hashId} userData={{following: 17, followers: 150}} />);
            break;
    ...
    return <div className={css.outerDiv}>
        <div className={css.innerDiv}>
            <div className={css.title}>{hashId}</div>
