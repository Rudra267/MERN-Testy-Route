...
let ShowCase = () => {
    ...
    useEffect(() => {
        const fetchDishes = async () => {
            try {
                const response = await fetch('/restaurants'); // Assuming your API endpoint is '/api/dishes'
                if (!response.ok) {
...
console.log(offers)
    return <Helmet title=" Great Today Offers">
    ...
    <div className={css.outerDiv}>
        ...
        <div className={css.innerDiv6}>
            <div className={css.w7}>
                ...
                {
  page === orderOnlinePage ? "Delivery Restaurants in Gachibowli" :
  page === nightLifePage ? "Nightlife Restaurants in Gachibowli" :
  <>
    Here are some exciting offers from Restaurants 
    <img className='position-absolute right-[38%] top-[23%]' src="https://gifdb.com/images/high/party-celebration-emoji-bvc569kafoe5ko8h.gif" width="55px" alt="" />
  </>
}
